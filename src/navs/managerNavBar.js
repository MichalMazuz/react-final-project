...
import { deleteMyCart } from '../features/order/orderSlice'

const pages = ['Orders', 'Users', 'Add Product', 'Products'];
          ...
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="log out">
                <IconButton onClick={handleLogOut} sx={{ p: 0, width: 50, height: 50 }}
                  size="large"
                  edge="end"
                  aria-label="account of current user"
                  aria-haspopup="true"
